...
class ClothingItemAdmin(admin.ModelAdmin):
    ...
    list_filter = ['is_active', 'is_available', 'category', 'size', 'created_at']
    search_fields = ['name', 'description']
...
class ClothingImageAdmin(admin.ModelAdmin):
    list_display = ['clothing_item', 'image_preview', 'order', 'created_at']
    list_filter = ['created_at']
    search_fields = ['clothing_item__name', 'alt_text']
    ordering = ['clothing_item', 'order']
...
@admin.register(BookingClothingItem)
class BookingClothingItemAdmin(admin.ModelAdmin):
    list_display = [
        'booking_id', 'booking_date', 'clothing_item', 'quantity',
    ...
    raw_id_fields = ['booking', 'clothing_item']
...
@admin.register(ClothingRentalSettings)
class ClothingRentalSettingsAdmin(admin.ModelAdmin):
    list_display = [
    ...
    def has_add_permission(self, request):
        ...
        return not ClothingRentalSettings.objects.exists()
